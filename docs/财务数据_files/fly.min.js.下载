...
void function() {
    var strategyListTemplate = [
        ...
        '<table class="table">',
            ...
            '<tbody>',
                ...
                '<tr>',
                    '<td class="name">',
                        '<a href="/hub/backtest/history/<%=value.backtest_id%>?user_id=<%=localStorage.user_id%>" target="_blank"> <%=value.name%> </a>',
                    '</td>',
                    '<td class="time">',
                        '<%=value.time%>',
                    '</td>',
    ...
    function removeAlgorithmData(id) {
        return $.ajax({
            method: 'POST',
            dataType: 'json',
            url: '/query_server/api/strategy/delete',
            data: {
                id: id,
    ...
    function historyBacktest(offset, strategy_id){
        ...
        $.ajax({
            method: 'POST',
            url: '/query_server/services/backtest/backtestlist',
            data: data,
...
void function() {
    ...
    function uplaodStrategy() {
        ...
        $.ajax({
            method: 'POST',
            url: '/query_server/uploadusercode',
            data: formdata,
            contentType: false,
            processData: false,
...
void function() {
    ...
    function getStrategyList() {
        $.ajax({
            method: 'POST',
            url: '/query_server/api/strategy/list',
            data: {
                business_type: business_type,
                user_id: localStorage.user_id
            },
