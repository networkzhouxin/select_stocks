...
Date: 2026-09-02
Version: `cross-v0.3.3-late-veto-early-pre-macd-candidate`
Experiment: Keep the rejected late-MACD/BOLL-upper veto, preserve the full official score-at-least-60 primary queue first, and append one leftover-slot-only early queue for score 50-59 observations whose fresh RSI and KDJ bullish crosses are age 0/1, whose MACD remains negative but narrows toward a bullish cross, whose close remains below the BOLL upper band, and whose RSI6 remains below 85. Keep every sell, sizing rule, ETF, cost, T-1 signal boundary, and 09:35 execution rule unchanged.
Hypothesis: A narrowly defined pre-MACD entry can recover valid reversals missed by waiting for the MACD cross, while the existing late-entry veto removes overheated confirmations, increasing closed-trade win rate by at least 3 percentage points without reducing return or increasing drawdown.
Training diagnostic result: The paired JoinQuant runs used 2019-01-01 through 2021-12-31, CNY 20,000, daily frequency, 09:35 execution, identical benchmark and nominal costs. The formal run returned +129.2480%, with 6.2838% maximum drawdown, 53 winners among 95 closed trades (55.7895%), and 5.2970 profit/loss ratio. The candidate returned +97.6525%, with 6.7473% maximum drawdown, 52 winners among 101 closed trades (51.4851%), and 3.7002 profit/loss ratio. Candidate annual returns remained positive at +23.0610%/+52.1818%/+5.5405%, but each was below the paired formal year. Display-precision log reconstruction estimated positive-to-negative round trips at 33 for formal and 38 for candidate.
Candidate result: Rejected at the nominal training gate. Return fell by 31.5955 percentage points, drawdown rose by 0.4635 percentage points, and win rate fell by 4.3043 percentage points instead of improving by at least 3 points. The candidate produced 20 actual early-channel fills spanning 2019/2020/2021; 19 were closed by period end, with 6 winners and 13 losers, while one remained open. The early sample and profit/loss-ratio floor passed, but they cannot override the failed return, drawdown, win-rate, and positive-to-negative gates.
JoinQuant training result: Completed once for each frozen source. Formal identity was `cross-v0.3.3`, build `20260822.2`, fingerprint `77e44d93d255`, log SHA-256 `579078194849C4DAD5A1FE7E2179153CEE356958332AA3F079BB27A62E5F258C`. Candidate identity was build `20260822.3-candidate`, fingerprint `f6b08195dd3d`, log SHA-256 `544CE0B9F283B1F1254C78AB8F854DB6D61A0219A014D6B1E99DFBF47BCAE14`. Both JoinQuant performance-summary screenshots were hashed and agreed with the complete logs. Independent trade exports were not provided; under the user-authorized `rejection_only_without_trade_exports` exception, this evidence may reject but cannot pass or adopt the candidate.
Validation result: Not run. The nominal training failure stopped doubled friction, reserved validation windows, and the full-period pair. No later-period result influenced this decision.
Why it failed: The appended early channel admitted too many false reversals. Its 6/19 closed-trade accuracy was insufficient to offset 13 losing early entries and the resulting portfolio-path changes. The combined veto did not repair that weakness: overall accuracy, payoff, and downside all worsened together, so this is not a trade-off that satisfies the user's nondegradation objective.
Can it be revisited? no as the stacked late-veto plus early-pre-MACD entry in the current framework
Conditions for revisiting: Keep the formal `cross-v0.3.3` source unchanged. Do not search neighboring score bands, cross ages, MACD narrowing definitions, BOLL distances, RSI thresholds, ETF/year exceptions, queue ordering, sizing, or sell-side compensation from this result. Reopening requires a genuinely independent prospective mechanism and explicit new authorization.
