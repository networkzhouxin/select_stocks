...
- Status: second-stage diagnostic ready for a JoinQuant run; 513050 and 513500 remain blocked from the formal `available_at` bundle regardless of probe outcome until publisher-level evidence or an explicitly approved contract change exists.
