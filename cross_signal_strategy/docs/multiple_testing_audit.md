...
- `docs/failed_experiments.md` retains 55 failed or non-adopted experiments.
- The selected frozen mainline contributes one additional selection.
- minimum trial count: 56
...
- Minimum-56 Bonferroni PSR p-value: 0.00694335
...
- Minimum-56 Bonferroni HAC p-value: 0.00348324

At the provable lower bound of 56 trials, both approximations remain below the
