# -*- coding: utf-8 -*-
"""
智能ETF量化交易策略 V15.6 - 豆粕→华宝油气
=============================================
基于V15.5，唯一改动：
  将159985豆粕ETF替换为162411华宝油气（标普油气上游指数LOF）

替换理由：
  - 豆粕ETF止损率42%（池中最高），农产品趋势短促、反转快
  - 华宝油气2011年上市（回测历史更长），能源价格趋势持续性远强于农产品
  - 与现有池资产相关性低（原油独立于A股/美股/黄金/国债）
