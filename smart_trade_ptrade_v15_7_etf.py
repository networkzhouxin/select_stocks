# -*- coding: utf-8 -*-
"""
智能ETF量化交易策略 V15.7 - PTrade版（回测+实盘兼容）
=============================================
从聚宽V15.7逐行移植，所有交易逻辑、参数、信号条件100%不变。
...
def initialize(context):
    ...
    g.etf_pool = [
        ...
        # ---- 跨市场 3只 ----
        '513100.SS',    # 纳指ETF（海外科技）
        '513500.SS',    # 标普500ETF（海外均衡）
        '159920.SZ',    # 恒生ETF（港股）
        # ---- 跨资产 3只 ----
        '518880.SS',    # 黄金ETF（避险）
